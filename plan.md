...
- should be able to configure globally and per-project using yaml or toml files
  - should be able to create a file called `sniffy.yml` to configure the application (which directories to include, which files to ignore, configure languages, set history limit, set date format, etc)
- should be able to store state in `.sniffy.json`
